...
public class Globin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            sprite.flipX = true;
            colliderAtk.offset = new Vector2(-0.6f, -0.64f);
            colliderCheckAtk.offset = new Vector2 (-0.65f, -0.39f);
        }
        else
        {
            sprite.flipX = false;
    ...
    private void Move()
    {
        ...
        if(GlobinCheckAttack.checkAttack == true)
        {
    ...
    IEnumerator Attack()
    {
        ...
        GlobinCheckAttack.checkAttack = false;
    }
